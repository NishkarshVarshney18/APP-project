...
System.out.println("\nThis borrower " + bor.getName() + " has no issued book
...
//-------------------INTERFACE---------------------------//
Library lib = Library.getInstance();
// Setting some by default information like name of library ,fine, deadline and limit
of hold request
lib.setFine(20);
...
System.out.println("3- Admininstrative Functions"); // Administration has access
only
System.out.println("
-----------------------------------------\n");
int choice = 0;
